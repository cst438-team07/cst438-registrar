<<<<<<< HEAD
MERGE INTO term (term_id, tyear, semester, add_date, add_deadline, drop_deadline, start_date, end_date) values
=======
...
<<<<<<< HEAD
MERGE INTO user_table (id, name, email, password, type) values
=======
...
<<<<<<< HEAD
MERGE INTO section (section_no, course_id, section_id, term_id, building, room, times, instructor_email) values
=======
